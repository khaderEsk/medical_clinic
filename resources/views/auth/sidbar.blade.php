...
<div class="sidebar">
    ...
    <div>
        <ul style='margin: 0 0 0 -30px'>
            ...
            <li>
                <a href="/student/add" class="sidebarItem">
                    <i class="fa fa-users fa-1x "></i>
                    <h6>Student</h6>
                </a>
            </li>
            <li>
                <a href="/teacher/get" class="sidebarItem">
                    <i class="fa fa-user-circle fa-1x "></i>
                    <h6>Employes</h6>
                </a>
            </li>
            <li>
                <a href="/expenses/get" class="sidebarItem">
                    <i class="fa fa-university fa-1x "></i>
                    <h6>Expenses</h6>
                </a>
            </li>
            <li>
                <a href="/free/add" class="sidebarItem">
                    <i class="fa fa-university fa-1x"></i>
                    <h6>Installments</h6>
                </a>
            </li>
            <li>
                <a href="/subject/getall" class="sidebarItem">
                    <i class="fa fa-folder fa-1x "></i>
                    <h6>Subject</h6>
                </a>
            </li>
            <li>
                <a href="/library/get" class="sidebarItem">
                    <i class="fa fa-address-book fa-1x"></i>
                    <h6>Library</h6>
                </a>
            </li>
            <li>
                <a href="/classroom/getall" class="sidebarItem">
                    <i class="fa fa-book fa-1x"></i>
                    <h6>Class Room</h6>
                </a>
            </li>
            <li>
                <a href="/weak/getall" class="sidebarItem">
                    <i class="fa fa-calendar fa-1x"></i>
                    <h6>work schedule</h6>
                </a>
            </li>
            <li>
                <a href="/final/getall" class="sidebarItem">
